...
public class insertModal extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int response = JOptionPane.showConfirmDialog(null, "Bạn có muốn thêm mới đơn nhập này?", "Thông báo",
...
//            }
            ...
            if (Util.validateImportInput(manuDate, expiryDate, importDate, quantities, avaiQuantities, unitPrice)) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Thêm mới đơn nhập thành công");
                    refreshDetail();
                } catch (SQLException ex) {
                    Logger.getLogger(insertModal.class.getName()).log(Level.SEVERE, null, ex);
                }
