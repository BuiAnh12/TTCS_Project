...
//        CellStatus cellStatus=new CellStatus(StatusType.IN_STOCK);
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã ", "Tên hàng", "Số lượng", "Khả dụng", "Trạng thái"
            }
        ) {
        ...
        txtImpDate.setForeground(new java.awt.Color(0, 0, 0));
        ...
        txtManuDate.setForeground(new java.awt.Color(0, 0, 0));
        ...
        txtExpDate.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jPanel25Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel25Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtCategory, javax.swing.GroupLayout.DEFAULT_SIZE, 237, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jLabel23.setBackground(new java.awt.Color(36, 36, 36));
...
//        refreshDetail();
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        if (row >= 0) {
            txtId.setText(String.valueOf(selectedImport.getImportId()));
