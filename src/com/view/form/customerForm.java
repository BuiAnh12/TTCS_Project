...
public class customerForm extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        sortComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sắp xếp theo Tên", "Sắp xếp theo Email", "Sắp xếp theo Tổng tiền", " " }));
        ...
        detail_table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sản phẩm", "Số lượng", "Giá cả", "Tổng tiền"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false
        ...
        jPanel20Layout.setVerticalGroup(
            jPanel20Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(spTable1, javax.swing.GroupLayout.DEFAULT_SIZE, 306, Short.MAX_VALUE)
        );
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        if (table.getSelectedRow() < 0) {
            JOptionPane.showMessageDialog(null, "Hãy chọn khách hàng cần muốn xóa!");
        } else {
            int response = JOptionPane.showConfirmDialog(null, "Bạn có muốn xóa khách hàng này không?", "Thông báo",
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        updateCustomer.setDataCustomer(selectedCustomer);
            ...
            JOptionPane.showMessageDialog(null, "Hãy chọn khách hàng cần muốn cập nhật!");
        }
