...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
//        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/view/icon/fertilizer.png")));
//        listMenu1.addItem(new Model_Menu("1", "Dashboard", Model_Menu.MenuType.MENU));
//        listMenu1.addItem(new Model_Menu("2", "Order", Model_Menu.MenuType.MENU));
//        listMenu1.addItem(new Model_Menu("7", "Product", Model_Menu.MenuType.MENU));
//        listMenu1.addItem(new Model_Menu("5", "Import", Model_Menu.MenuType.MENU));
...
//        listMenu1.addItem(new Model_Menu("8", "Staff", Model_Menu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/view/icon/seed-bag (1).png"))); // NOI18N
        jLabel1.setText("CropTech");
    ...
    protected void paintChildren(Graphics grphcs) {
        ...
        // GradientPaint g = new GradientPaint(0, 0, Color.decode("#1CB5E0"), 0,
        // getHeight(), Color.decode("#000046"));
        // g2.setPaint(g);
